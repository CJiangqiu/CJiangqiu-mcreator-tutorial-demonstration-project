...
public class LandAgentTrade2Procedure {
	public static void execute(Entity entity) {
		...
		if (new Object() {
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof Supplier _current && _current.get() instanceof Map _slots) {
				ItemStack _setstack = new ItemStack(EpicJourneyModItems.HOUSE_PROPERTY_MEDIUM_SIZED_WOODEN_HOUSE.get());
				_setstack.setCount((int) coin_number);
				((Slot) _slots.get(4)).set(_setstack);
				_player.containerMenu.broadcastChanges();
			}
			if (entity instanceof Player _player && _player.containerMenu instanceof Supplier _current && _current.get() instanceof Map _slots) {
				((Slot) _slots.get(1)).remove((int) (coin_number * 6));
				_player.containerMenu.broadcastChanges();
			}
