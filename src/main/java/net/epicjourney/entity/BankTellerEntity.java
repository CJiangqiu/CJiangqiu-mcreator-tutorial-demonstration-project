...
import net.epicjourney.procedures.BankTellerShiTiChuShiShengChengShiProcedure;
...
public class BankTellerEntity extends PathfinderMob {
	public static final EntityDataAccessor<Integer> DATA_texture = SynchedEntityData.defineId(BankTellerEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_potion_number = SynchedEntityData.defineId(BankTellerEntity.class, EntityDataSerializers.INT);

	public BankTellerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EpicJourneyModEntities.BANK_TELLER.get(), world);
	}

	public BankTellerEntity(EntityType<BankTellerEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 5;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(DATA_potion_number, 3);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new MoveBackToVillageGoal(this, 0.6, false) {
			...
			public boolean canUse() {
				double x = BankTellerEntity.this.getX();
				double y = BankTellerEntity.this.getY();
				double z = BankTellerEntity.this.getZ();
				Entity entity = BankTellerEntity.this;
				Level world = BankTellerEntity.this.level();
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(EpicJourneyModItems.GOLD_COIN.get()));
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		BankTellerShiTiChuShiShengChengShiProcedure.execute(this);
		return retval;
	}
	...
	public void addAdditionalSaveData(CompoundTag compound) {
		...
		compound.putInt("Datapotion_number", this.entityData.get(DATA_potion_number));
	...
	public void readAdditionalSaveData(CompoundTag compound) {
		...
		if (compound.contains("Datapotion_number"))
			this.entityData.set(DATA_potion_number, compound.getInt("Datapotion_number"));
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Bank Teller");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(BankTellerEntity.this.getId());
					return new BankTellerTradeGuiMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
