...
import net.epicjourney.procedures.TestBossDangShiTiShouShangShiProcedure;
...
public class TestBossEntity extends Monster {
	...
	public TestBossEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EpicJourneyModEntities.TEST_BOSS.get(), world);
	}
	...
	public TestBossEntity(EntityType<TestBossEntity> type, Level world) {
		...
		xpReward = 100;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(EpicJourneyModItems.TEST_WEAPON.get()));
	}
	...
	public boolean hurt(DamageSource damagesource, float amount) {
		...
		TestBossDangShiTiShouShangShiProcedure.execute(entity);
