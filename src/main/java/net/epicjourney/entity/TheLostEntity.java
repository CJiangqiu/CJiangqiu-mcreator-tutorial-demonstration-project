...
import net.epicjourney.procedures.TheLostShiTiChuShiShengChengShiProcedure;
...
public class TheLostEntity extends Monster implements GeoEntity {
	...
	public TheLostEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(EpicJourneyModEntities.THE_LOST.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(7, new FollowMobGoal(this, 0.5, (float) 16, (float) 8));
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("epic_journey:the_lost_ambient"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("epic_journey:the_lost_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("epic_journey:the_lost_death"));
	}

	@Override
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		SpawnGroupData retval = super.finalizeSpawn(world, difficulty, reason, livingdata, tag);
		TheLostShiTiChuShiShengChengShiProcedure.execute(this);
		return retval;
	}
	...
	public static void init() {
		SpawnPlacements.register(EpicJourneyModEntities.THE_LOST.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			...
			return event.setAndContinue(RawAnimation.begin().thenLoop("animation.model.live"));
		}
